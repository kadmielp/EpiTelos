...
const MOCK_SAMPLE_FILES = [
  ...
  '/contexts_sample2/yearreview.md',
  '/contexts_sample2/folder1/journal-sample.md',
  '/contexts_sample2/folder1/yearreview-sample.md',
  '/contexts_sample2/folder1/subfolder2/subfolderjournal.md',
];
